...
// Virtual Manager Modular Components
...
export const AdminPage: React.FC = () => {
  ...
  // Tab State & View Mode
  const [activeTab, setActiveTab] = useState<'bookings' | 'finance' | 'inventory' | 'expenses' | 'plans' | 'crm' | 'team' | 'services' | 'gallery' | 'add'>('bookings');
  ...
  const handleLogin = () => {
    ...
    if (password === 'galdino') {
      ...
      const foundBarber = bList.find((b) => b.pinCode === password);
      if (foundBarber) {
        setIsAuthenticated(true);
...
📋 *Serviço:* ${b.service}
💈 *Barbeiro:* ${b.barberName || 'Seu Galdino'}
...
💈 *Profissional:* ${b.barberName || 'Seu Galdino'}
📋 *Serviço:* ${b.service}
📍 *Endereço:* ${ADDRESS}
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="relative w-full max-w-sm">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-sm text-muted-foreground mt-1">Barbearia Seu Galdino</p>
          </div>
  ...
  return (
    <div className="min-h-screen bg-background text-foreground pb-12">
      <div className="max-w-7xl mx-auto p-4 md:p-6 space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-xl font-bold tracking-tight">Barbearia Seu Galdino</h1>
            ...
            >
              ...
              {!loggedInBarber && (
                <>
                  ...
                  <option value="plans">✨ Planos & Recorrência</option>
              ...
              <div className="flex items-center bg-secondary p-1 rounded-xl border border-border shrink-0">
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                    agendaViewMode === 'timeline' ? 'bg-primary text-black shadow-sm' : 'text-muted-foreground'
                  }`}
                >
                  Modo 30min
                </button>
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                    agendaViewMode === 'cards' ? 'bg-primary text-black shadow-sm' : 'text-muted-foreground'
                  }`}
                >
                  Cards
                </button>
                      ...
                      >
                        <div>
                          ...
                          <div className="mt-3 p-3 rounded-xl bg-secondary/50 border border-border space-y-1 text-xs">
                            ...
                            <div className="flex justify-between text-muted-foreground">
                              <span>Barbeiro:</span>
                              <strong className="text-primary">{b.barberName || 'Seu Galdino'}</strong>
                            </div>
                        ...
                        <div className="space-y-2 pt-2 border-t border-border">
                          <div className="flex gap-2">
                            ...
                            <button
                              ...
                              className="flex-1 py-2 bg-primary text-black font-extrabold rounded-xl text-xs transition-all hover:bg-primary/90 cursor-pointer flex items-center justify-center gap-1 shadow-[0_0_10px_-2px_hsl(45_97%_54%/0.4)]"
                            >
        ...
        {/* TAB 3: PLANS & RECURRENCE */}
        {activeTab === 'plans' && !loggedInBarber && (
          <PlansManager
            plans={plans}
            subscriptions={subscriptions}
            onSavePlans={(p) => {
          ...
          <div className="bg-card border border-border rounded-3xl p-6 md:p-8 max-w-xl mx-auto card-shadow space-y-6">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full py-3.5 bg-primary text-black font-extrabold rounded-xl text-sm transition-all hover:bg-primary/90 disabled:opacity-50 cursor-pointer shadow-[0_0_20px_-5px_hsl(45_97%_54%/0.4)]"
              >
