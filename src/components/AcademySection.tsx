...
export const AcademySection: React.FC = () => {
  const courseMessage =
    'Olá! Vi o curso Seu Galdino Academy e tenho interesse em aprender a ser barbeiro. Poderia me passar mais informações?';
  ...
  return (
    <section className="py-24 px-4 md:px-6 max-w-5xl mx-auto">
      <div className="text-center mb-12">
        ...
        >
          Seu Galdino <span className="text-academy academy-text-glow">Academy</span>
        </motion.h2>
      </div>
      ...
      <div className="space-y-8">
        ...
        >
          <img
            ...
            alt="Aluno do curso prático Seu Galdino Academy"
