    ...
    <section id="assinaturas" className="py-20 px-4 md:px-6 max-w-6xl mx-auto">
      ...
      <div className="mb-14 p-6 md:p-8 rounded-3xl bg-gradient-to-r from-card via-card/90 to-primary/10 border border-primary/30 card-shadow max-w-xl mx-auto">
        <div className="flex items-center gap-3 mb-4">
          <div className="p-2.5 rounded-2xl bg-primary text-black font-extrabold">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          ...
          <button
            ...
            className="px-6 py-3 bg-primary text-black font-extrabold rounded-xl text-sm hover:bg-primary/90 transition-all cursor-pointer whitespace-nowrap"
          >
            Ver Meus Cortes
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {WHITELABEL_CONFIG.defaultPlans.map((plan, idx) => (
          ...
          >
            {idx === 0 && (
              <div className="absolute top-4 right-4 bg-primary text-black font-extrabold text-[10px] uppercase px-2.5 py-1 rounded-full shadow-md">
                Mais Vendido
              </div>
            )}
            ...
            <button
              ...
              className="w-full py-3.5 bg-primary text-black font-extrabold rounded-xl text-xs hover:bg-primary/90 transition-all cursor-pointer flex items-center justify-center gap-2 shadow-[0_0_15px_-3px_hsl(45_97%_54%/0.4)]"
            >
