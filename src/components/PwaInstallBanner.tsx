        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3.5 py-2 bg-primary text-black font-extrabold text-xs rounded-xl hover:bg-primary/90 transition-all shadow-[0_0_15px_-3px_hsl(45_97%_54%/0.5)] cursor-pointer whitespace-nowrap flex items-center gap-1"
            >
          ...
          <div className="bg-card border border-border rounded-3xl w-full max-w-sm p-6 space-y-5 text-center relative shadow-2xl">
            ...
            <ol className="text-xs text-muted-foreground space-y-3 text-left bg-secondary/50 p-4 rounded-2xl border border-border">
              <li className="flex items-center gap-2">
                <span className="w-6 h-6 rounded-full bg-primary text-black font-bold flex items-center justify-center text-[11px] shrink-0">
                  1
                </span>
                <span>
            ...
            <button
              onClick={() => setShowIosGuide(false)}
              className="w-full py-3 bg-primary text-black font-bold rounded-xl text-xs hover:bg-primary/90"
            >
              Entendido!
            </button>
          </div>
