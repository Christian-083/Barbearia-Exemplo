...
export const AboutGaldino: React.FC = () => {
  return (
    <section className="py-24 px-6 max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
      ...
      >
        <img
          src="https://i.imgur.com/BNEImdC.png"
          alt="Seu Galdino"
          className="rounded-3xl w-full aspect-square object-cover card-shadow border border-border/40"
        />
        <div className="absolute -bottom-4 -right-4 md:-bottom-6 md:-right-6 bg-primary text-primary-foreground p-4 md:p-6 rounded-2xl shadow-[0_10px_25px_-5px_hsl(45_97%_54%/0.5)]">
