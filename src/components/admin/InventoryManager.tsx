      ...
      <div className="p-6 rounded-3xl bg-card border border-border flex flex-col md:flex-row justify-between items-start md:items-center gap-4 shadow-xl">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <button
            ...
            className="px-4 py-2.5 bg-primary text-black font-extrabold text-xs rounded-xl hover:bg-primary/90 transition-all cursor-pointer flex items-center gap-2 shadow-[0_0_15px_-3px_hsl(45_97%_54%/0.4)]"
          >
          ...
          <div className="bg-card border border-border rounded-3xl w-full max-w-md p-6 space-y-5 shadow-2xl relative">
            ...
            <form onSubmit={handleSaveProduct} className="space-y-4">
              ...
              <div className="flex justify-end gap-2 pt-3 border-t border-border">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 bg-primary text-black font-extrabold rounded-xl text-xs hover:bg-primary/90"
                >
                  Salvar Produto
                </button>
              </div>
