...
import { Booking, Barber, CustomerProfile, CustomerSubscription } from '../../types';
                  ...
                  {slotItems.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      {slotItems.map((b) => {
                        ...
                        const sub = subscriptions.find((s) => s.customerPhone && b.phone && s.customerPhone.replace(/\D/g, '') === b.phone.replace(/\D/g, ''));
                          ...
                          >
                            <div>
                              ...
                              <p className="text-[11px] text-muted-foreground flex items-center gap-1">
                                ...
                                <strong className="text-foreground">{b.barberName || 'Seu Galdino'}</strong>
                              </p>
                            ...
                            <div className="flex items-center gap-2 pt-2 border-t border-border/60">
                              <button
                                ...
                                className="flex-1 py-1.5 bg-primary text-black font-extrabold text-[11px] rounded-lg hover:bg-primary/90 flex items-center justify-center gap-1 cursor-pointer"
                              >
