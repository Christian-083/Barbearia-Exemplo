    ...
    <div className="space-y-8">
      ...
      <div className="p-6 rounded-3xl bg-card border border-border card-shadow flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <button
          ...
          className="px-5 py-3 rounded-2xl bg-primary text-black font-extrabold text-xs flex items-center gap-2 hover:bg-primary/90 transition-all cursor-pointer shadow-[0_0_15px_-3px_hsl(45_97%_54%/0.4)]"
        >
          ...
          <div className="bg-card border border-border rounded-3xl w-full max-w-md p-6 space-y-5 shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex justify-end gap-2 pt-2 border-t border-border">
              ...
              <button
                ...
                className="px-5 py-2 rounded-xl bg-primary text-black font-extrabold text-xs"
              >
                Salvar Alterações
              </button>
            </div>
          ...
          <div className="bg-card border border-border rounded-3xl w-full max-w-md p-6 space-y-5 shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex justify-end gap-2 pt-2 border-t border-border">
              ...
              <button
                ...
                className="px-5 py-2 rounded-xl bg-primary text-black font-extrabold text-xs disabled:opacity-50"
              >
                Cadastrar
              </button>
            </div>
