      ...
      <div className="bg-card border border-border rounded-3xl w-full max-w-2xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden">
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-primary text-black font-bold rounded-xl text-xs hover:bg-primary/90 disabled:opacity-50 cursor-pointer"
                >
        ...
        <div className="p-4 border-t border-border bg-secondary/30 flex justify-end gap-3">
          ...
          <button
            ...
            className="px-6 py-2.5 rounded-xl bg-primary text-black font-extrabold text-sm hover:bg-primary/90 transition-all cursor-pointer disabled:opacity-50 flex items-center gap-2 shadow-[0_0_15px_-3px_hsl(45_97%_54%/0.4)]"
          >
