              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="px-4 py-1.5 rounded-xl bg-primary text-black font-extrabold text-xs flex items-center gap-1.5 hover:bg-primary/90 cursor-pointer"
                  >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 rounded-xl bg-primary text-black font-bold text-xs hover:bg-primary/90 disabled:opacity-50 cursor-pointer"
                    >
