    ...
    <div className="bg-card border border-border rounded-3xl p-6 md:p-8 card-shadow space-y-8">
      ...
      <div className="p-5 rounded-2xl bg-secondary/50 border border-border grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-3">
          ...
          <label className="flex items-center justify-center gap-3 px-6 py-3.5 bg-primary text-black font-extrabold rounded-xl cursor-pointer hover:bg-primary/90 transition-all card-shadow w-full">
        ...
        <div className="space-y-3">
          ...
          <form onSubmit={handleAddByUrl} className="flex gap-2">
            ...
            <button
              ...
              className="px-4 py-2.5 bg-primary text-black font-bold rounded-xl hover:bg-primary/90 disabled:opacity-50 transition-all flex items-center gap-1 shrink-0"
            >
