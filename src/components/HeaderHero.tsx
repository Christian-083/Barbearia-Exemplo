...
export const HeaderHero: React.FC = () => {
  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <img
        src="https://i.imgur.com/dyQTeXI.png"
        alt="Barbearia Seu Galdino"
      ...
      >
        ...
        <motion.button
          ...
          animate={{
            boxShadow: [
              '0 0 20px hsl(45 97% 54% / 0.3), 0 0 40px hsl(45 97% 54% / 0.15)',
              '0 0 30px hsl(45 97% 54% / 0.5), 0 0 60px hsl(45 97% 54% / 0.3)',
              '0 0 20px hsl(45 97% 54% / 0.3), 0 0 40px hsl(45 97% 54% / 0.15)',
            ],
            scale: [1, 1.03, 1],
          }}
